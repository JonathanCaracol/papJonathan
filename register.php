...
<section>
    <div class="container">
        <div class="text-center">
            ...
            <p class="lead">Crie uma conta no nosso site e ajude muitas pessoas!</p>
        </div>
    </div>
</section>
            ...
            <div class="col-md-6 col-sm-12">
                <form id="contact-form" role="form" action="" method="post">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <input type="email" class="form-control" placeholder="Escreva o seu numero de telemovel" name="email" required>

                        <input type="email" class="form-control" placeholder="Escreva a sua morada inteira" name="email" required>
                    </div>

                    <div class="col-md-12 col-sm-12">
                        <input type="submit" class="form-control" name="send message" value="Criar conta">
                        <input type="submit" class="form-control" name="send message" value="Já tem conta? Entre nela!"><a href="login.php">login</a>
                    </div>
