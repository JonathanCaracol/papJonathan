<?php
    ...
    $pontosUtilizador="select * from utilizadores where utilizadorId=".$_SESSION['id'];
    $pontosResult=mysqli_query($con,$pontosUtilizador);
    $pontosDados=mysqli_fetch_array($pontosResult);
                        ...
                        <div style="margin-left: 10%" class="col-md-6 col-sm-12">
                            <form id="contact-form" role="form" action="admin/confirmaEditaPerfil.php?id=<?php echo $dados['utilizadorId']?>" enctype="multipart/form-data" method="post">
                                <div class="col-md-12 col-sm-12">
                                    <a href="pedidos.php" class="badge badge-pill" style="background-color: white;color: #29ca8e"><span class="badge badge-pill" style="background-color: white; color: #29ca8e"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell-fill" viewBox="0 0 16 16">
                                            <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z"/>
                                        </svg><?php echo $notif; ?></span></a>
                                    <a class="badge badge-pill" style="margin-left: 60%;background-color: white;color: #29ca8e"><span class="badge badge-pill" style="background-color: white; color: #29ca8e">
                                            Pontos disponíveis: <?php echo $pontosDados['utilizadorPontos']; ?></span></a>
